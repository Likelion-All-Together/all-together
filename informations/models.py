...
class RegionAndMulticultural(models.Model):
    ...
    tag1 = models.CharField(verbose_name = '태그1', max_length = 20, default = None, null = True)
    tag2 = models.CharField(verbose_name = '태그2', max_length = 20, default = None, null = True) 
