...
from .views import scrap_view,identify_view, class_apply_view, jobs_creat_view, jobs_main_view, jobs_teacher_view, jobs_teacher_detail_view
...
urlpatterns = [
    ...
    path('teacher/scrap/<int:bid>',scrap_view), #좋아요
]